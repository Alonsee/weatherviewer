...
public class WeatherServiceImpl implements WeatherService {
	...
	public SingleDayWeather getCurrentWeather(String selectedcity, String weatherProvider)
		...
		if (weatherProvider.equalsIgnoreCase("yandex")) {	
				...
				Document document = Jsoup.connect("https://yandex.ru/pogoda/" 
				                                  + city.getCityDescribeYa() 
				                                  + "/details").get();
		...
		if (weatherProvider.equalsIgnoreCase("gismeteo")) {
				Document document = Jsoup.connect("https://www.gismeteo.ru/weather"
		                                          +city.getCityDescribeGo()).get();
